...
//@ComponentScan(value = {"Tests.hibernate_test.dao"})
@ComponentScan({"Tests/hibernate_test"})
...
//      sessionFactory.setConfigLocation(new PathResource("src/main/resources/hibernate.cfg.xml"));
